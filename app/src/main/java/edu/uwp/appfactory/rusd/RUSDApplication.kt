...
class RUSDApplication : Application() {
    ...
    companion object {
        ...
        fun setAuthToken(context: Context, token: String?) {
            ...
            Log.d("Auth Token", "Bearer $token saved to prefs.")
        }
        ...
        fun setExpiresAt(context: Context, expiresIn: Long) {
            ...
            Log.d("Expires At", "$expiresAt saved to prefs.")
        }
        ...
        fun setRefreshToken(context: Context, token: String) {
            ...
            Log.d("Refresh Token", "$token saved to prefs.")
        }
        ...
        fun logout(context: Context) {
            ...
            Log.d("User logged out", "authToken, expiresAt, refreshToken reset in prefs.")
